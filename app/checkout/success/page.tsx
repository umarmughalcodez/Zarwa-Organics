...
//       if (!orderDetails) {
//         console.log('❌ [Download Debug] No orderDetails, checking localStorage...');
//         const savedOrder = localStorage.getItem("zarwa_temp_order");
//         if (savedOrder) {
//           const parsedOrder = JSON.parse(savedOrder);
//           console.log('✅ [Download Debug] Found order in localStorage:', parsedOrder);
...
//                       <span>- Rs. {orderDetails.totalSavings}</span>
//                     </div>
//                   )}
...
//                       <span>- Rs. {orderDetails.couponDiscount}</span>
//                     </div>
//                   )}
...
//                       <span>- Rs. {orderDetails.bulkDiscount}</span>
//                     </div>
//                   )}
...
//   <div>LocalStorage: {typeof window !== 'undefined' ? (localStorage.getItem('zarwa_temp_order') ? 'Has Data' : 'Empty') : 'No Window'}</div>
//   <Button
//     variant="outline"
//     size="sm"
//     onClick={() => {
                    ...
                    orderDetails.securityDeposit > 0 && (
                      <>
                        ...
                        <div className="text-red-500 text-sm">
                          (Note: If you’ve already paid, we’ll verify your
                          payment shortly and notify you once it’s confirmed. If
                          not, please complete your pre-order payment to secure
                          your order)
                        </div>
